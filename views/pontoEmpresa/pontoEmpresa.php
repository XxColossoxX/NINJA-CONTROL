...
<div class="min-h-screen flex flex-col items-center justify-center px-4">
    <div class="w-full max-w-6xl bg-[#0d1628]/90 backdrop-blur-md border border-cyan-500/20 rounded-2xl shadow-[0_0_20px_#00ffff20] p-0 mt-4 flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-start md:p-4 p-2 border-b md:border-b-0 md:border-r border-cyan-400">
            ...
            <!-- Header mobile -->
            <div class="md:hidden flex items-center gap-4 mb-4 pl-2">
                <img id="imgFuncionario" src="/../../assets/img/iconDefault.png" alt="Foto do Funcionário"
                    class="w-12 h-12 rounded-full object-cover border-2 border-cyan-500 ml-2">
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-center md:p-4 p-2">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-slate-800/80 border border-cyan-500/10 rounded-xl p-3 flex flex-col items-center shadow-[0_0_10px_#00ffff10]">
            ...
            <!-- Localização -->
            <div class="mb-6">
                <label class="block text-sm font-bold mb-2 font-bold text-white" for="localizacao">Localização Atual</label>
                <div class="bg-slate-800/80 border border-cyan-500/10 shadow-[0_0_10px_#00ffff10] flex items-center bg-gray-100 rounded-lg p-2 glow-box">
                    <i class="fas fa-map-marker-alt text-cyan-400 text-xl mr-2"></i>
                    <input id="inputLocalizacao" type="text" value="<?php echo isset($_SESSION['empresa_loc']) ? $_SESSION['empresa_loc'] : 'Endereço não disponível'; ?>"
                           class="w-full bg-slate-800/80 border border-cyan-500/10 shadow-[0_0_10px_#00ffff10] border-none outline-none font-bold text-white text-sm" readonly>
                </div>
            </div>

            <!-- Botão bater ponto -->
            <div class="flex justify-center mt-6 mb-4">
                <button id="btnBaterPonto" class="relative bg-cyan-500/90 hover:bg-cyan-400 text-slate-900 font-bold py-3 px-6 rounded-lg text-lg shadow-[0_0_15px_#00ffff40] transition-all hover:shadow-[0_0_25px_#00ffff80] hover:scale-105 flex items-center gap-2 text-white">
...
<div id="modal-dados-funcionario" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
    <div class="bg-[#101a2b]/95 md:border md:border-cyan-500/20 text-slate-100 rounded-2xl shadow-[0_0_25px_#00ffff20] p-6 backdrop-blur-xl">
...
<div id="modal-bater-ponto" class="fixed inset-0 bg-black bg-opacity-60 z-50 hidden flex items-center justify-center">
    <div class="bg-slate-900 rounded-xl shadow-lg w-full max-w-lg md:max-w-2xl lg:max-w-3xl relative p-2 sm:p-4 overflow-y-auto h-auto">
       <h2 class="text-xl font-bold text-white text-center mb-4 flex items-center justify-center gap-2">
        ...
        <div class="flex justify-between items-center mt-4">
            ...
            <button id="btn-efetuar-ponto" class="bg-cyan-500 text-white px-4 py-2 rounded hover:bg-cyan-700 transition font-bold">
