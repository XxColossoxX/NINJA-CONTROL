...
function updateFuncionario($db, $data){
    ...
    if ($data && isset($data['ID_FUNCIONARIO'])) {
        ...
        // Criptografa apenas se veio senha nova
        ...
        if ($senhaHash) {
            ...
            $executou = $stmt->execute([$nome, $cpf, $rg, $dataNascimento, $faceId, $senhaHash, $idFuncionario]);
            ...
            $executou = $stmt->execute([$nome, $cpf, $rg, $dataNascimento, $faceId, $idFuncionario]);
        }
